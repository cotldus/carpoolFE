...
export const GlobalToggles = () => {
  ...
  return (
    <FormControl
      ...
      className="relative self-center sm:absolute sm:right-0 sm:pr-4 mr-4"
    >
      <div className="relative border rounded self-center sm:absolute sm:right-0 sm:px-1 bg-gradient-to-r from-green-100 to-blue-200 hover:from-pink-200 hover:to-yellow-200 ...">
